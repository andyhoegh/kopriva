...
```{r, out.width = "600px"}
knitr::include_graphics("chair.jpeg")
```
...
## Data Overview: Year-by-Year

```{r, out.width = "600px"}
knitr::include_graphics("/Volumes/GoogleDrive/My Drive/Research/presentations/MSU_Colloquium/yearly_locations.png")
```

## Data Overview: Bear-by-Year

```{r, out.width = "600px"}
knitr::include_graphics("/Volumes/GoogleDrive/My Drive/Research/presentations/MSU_Colloquium/bear_year.png")
```
